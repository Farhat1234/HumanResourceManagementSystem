    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="hpanel">
                        ...
                        <div class="contentform">
                            ...
                            <div class="leftcontact">
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="ddlNIO" InitialValue="---Select NIO Type---" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                </div>
                            ...
                            <div class="rightcontact">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:CompareValidator ID="CompareValidator1" ValidationGroup="Date" ForeColor="Red"
                                        ...
                                        Operator="LessThan" Type="Date" style="margin:76px;" ErrorMessage="To Date must be greater than From Date.">
                ...
                <asp:CheckBox ID="chkTick" runat="server" Text=" I hereby declare that I fully understand and agree to the Terms and Conditions of the Company" />
