<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="OnDutyHistory.aspx.cs" Inherits="HumanResourceApplication.OnDutyHistory" %>
        ...
        <tr>
            <td>
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="Both">
                    ...
                    <Columns>
                        <asp:BoundField HeaderText="Nio Category" DataField="TypeOf"/>
                        ...
                        <asp:BoundField HeaderText="Days" DataField=""/>
                        <asp:BoundField HeaderText="Comments" DataField="Reason"/>
                        <asp:BoundField HeaderText="Status" DataField="Status"/>
                        <asp:BoundField HeaderText="Approver" DataField="Approver"/>
                    </Columns>
                </asp:GridView>
            </td>
        </tr>
