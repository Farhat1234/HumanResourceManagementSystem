<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Band A Payslip.aspx.cs" Inherits="HumanResourceApplication.Salary_Mgt.Band_A_Payslip" EnableEventValidation="false" %>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="text-center m-b-md">
                <h3><b>Employee Band A PaySlip </b></h3>
            ...
            <div class="hpanel">
                <div class="panel-body">
                    <form>
                        ...
                        <div class="contentform">
                            ...
                            <div class="leftcontact">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="DrpDomain" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DrpDomain_SelectedIndexChanged" ToolTip="Select the expierence" class="dropdownlist">
                                ...
                                <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Italic="True" Font-Size="Large" ForeColor="White" Text="Deductions"></asp:Label>
                                ...
                                <p><b>TOTAL DEDUCTIONS CURRRENT MONTH NET SALARY</b></p>
                            ...
                            <div class="rightcontact">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="DrpAprsPerc" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DrpAprsPerc_SelectedIndexChanged" class="dropdownlist">
                        ...
                        <asp:ImageButton ID="ImageButton1" runat="server" class="btn btn-success" style="margin-left:430px" />
    ...
    <table class="center" align="center">
        <tr>
            ...
            <table class="style4">
                ...
                <tr>
                    <td bgcolor="#373737" class="auto-style6" colspan="2"></td>
                </tr>
                <tr>
                    <td class="auto-style6"></td>
                    <td class="style12"></td>
