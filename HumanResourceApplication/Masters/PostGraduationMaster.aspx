<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="PostGraduationMaster.aspx.cs" Inherits="HumanResourceApplication.Masters.PostGraduationMaster" %>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="text-center m-b-md">
                <h3><b>Add New Post Graduation</b></h3>
                <small>Fill the form to add a new post graduation</small>
            </div>
                    ...
                    <div class="contentform">
                        <div class="leftcontact">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtPostGraduation" runat="server" placeholder="Enter A Post Graduation"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                </div>
