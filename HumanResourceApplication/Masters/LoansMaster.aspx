<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="LoansMaster.aspx.cs" Inherits="HumanResourceApplication.Masters.LoansMaster" %>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="text-center m-b-md">
                <h3><b>Add New Loan Type</b></h3>
                <small>Fill the form to add a new loan type</small>
            </div>
                    ...
                    <div class="contentform">
                        <div class="leftcontact">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtLoanType" runat="server" placeholder="Enter A Loan Type"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                </div>
