<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="LeavesMaster.aspx.cs" Inherits="HumanResourceApplication.Masters.LeavesMaster" %>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="text-center m-b-md">
                <h3><b>Add New Leave Type</b></h3>
                <small>Fill the form to add a new leave type</small>
            </div>
                    ...
                    <div class="contentform">
                        <div class="leftcontact">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtLeaveType" runat="server" placeholder="Enter A Leave Type"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                </div>
