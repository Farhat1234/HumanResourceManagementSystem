<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="GraduationMaster.aspx.cs" Inherits="HumanResourceApplication.Masters.GraduationMaster" %>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="text-center m-b-md">
                <h3><b>Add New Graduation</b></h3>
                <small>Fill the form to add a new graduation</small>
            </div>
                    ...
                    <div class="contentform">
                        <div class="leftcontact">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtGraduation" runat="server" placeholder="Enter A Graduation"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                </div>
