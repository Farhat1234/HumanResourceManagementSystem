<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DoctorateMaster.aspx.cs" Inherits="HumanResourceApplication.Masters.DoctorateMaster" %>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="text-center m-b-md">
                <h3><b>Add New Doctorate</b></h3>
                <small>Fill the form to add a new doctorate</small>
            </div>
                    ...
                    <div class="contentform">
                        <div class="leftcontact">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtDoctorate" runat="server" placeholder="Enter A Doctorate"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                </div>
