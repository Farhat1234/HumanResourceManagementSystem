    ...
    <div class="row">
        <div class="col-md-12">
            <div class="text-center m-b-md">
                <h3><b>Add New Department</b></h3>
                <small>Fill the form to add a new department</small>
            </div>
                    ...
                    <div class="contentform">
                        <div class="leftcontact">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtDepartment" runat="server" placeholder="Enter A Department"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                </div>
