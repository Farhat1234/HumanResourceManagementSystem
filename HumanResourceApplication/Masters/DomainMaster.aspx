<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DomainMaster.aspx.cs" Inherits="HumanResourceApplication.Masters.DomainMaster" %>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="text-center m-b-md">
                <h3><b>Add New Job Domain</b></h3>
                <small>Fill the form to add a new job domain</small>
            </div>
                    ...
                    <div class="contentform">
                        <div class="leftcontact">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtJobDomain" runat="server" placeholder="Enter A Job Domain"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                </div>
