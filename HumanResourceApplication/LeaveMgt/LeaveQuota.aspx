<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="LeaveQuota.aspx.cs" Inherits="HumanResourceApplication.Leave_Mgt.LeaveQuota" %>
    ...
    <table class="style1">
        <tr>
            ...
            <td class="auto-style6">
                <asp:GridView ID="grdLeave" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="Both" BorderWidth="2">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Deductible From">
                            <ItemTemplate>
                                <asp:Label ID="DeductibleFrom" runat="Server"
                                    Text='<%# Eval("DeductibleFrom", "{0:dd/MM/yyyy}") %>' />
                            </ItemTemplate>                            
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Deductible To">
                            <ItemTemplate>
                                <asp:Label ID="DeductibleTo" runat="Server"
                                    Text='<%# Eval("DeductibleTo", "{0:dd/MM/yyyy}") %>' />
                            </ItemTemplate>                            
                        </asp:TemplateField>
                        <asp:BoundField DataField="Entitlement" HeaderText="Entitlement" />
                        <asp:TemplateField HeaderText="Used Leave">
                            <ItemTemplate>
                                <asp:Label ID="UsedLeave" runat="Server"
                                    Text='<%# Eval("UsedLeaves") %>' />
                            </ItemTemplate>                            
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Remainder">
                            <ItemTemplate>
                                <asp:Label ID="Remainder" runat="Server"
                                    Text='<%# Eval("Remainder") %>' />
                            </ItemTemplate>                            
                        </asp:TemplateField>
                    </Columns>
