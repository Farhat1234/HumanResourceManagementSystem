<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ApproveLeaves.aspx.cs" Inherits="HumanResourceApplication.Leave_Mgt.ApproveLeaves" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
   <style>
       #ContentPlaceHolder1_grdApproveLeave {
           width: 125%;
           height: 250px;
           text-align: center;
       }
    ...
    <table class="style1">
        <tr>
            ...
            <td class="auto-style6">
                <asp:GridView ID="grdApproveLeave" runat="server" CellPadding="4" ForeColor="#333333" GridLines="Both" AutoGenerateColumns="False" OnRowCommand="grdApproveLeave_RowCommand" >
                    ...
                    <Columns>
                       ...
                       <asp:TemplateField HeaderText="To Date">
                            <ItemTemplate>
                                <asp:Label ID="ToDate" runat="Server"
                                    Text='<%# Eval("ToDate", "{0:dd/MM/yyyy}") %>' />
                            </ItemTemplate>                            
                        </asp:TemplateField>
                        <asp:BoundField DataField="NoofDays"  HeaderText="No:of Days"/>
                        <asp:BoundField DataField="Reason" HeaderText="Note for Approver" />
                        <asp:BoundField DataField="LeaveTypeID" HeaderText="Leave Type" />
                        <asp:TemplateField HeaderText="Approve">
                            <ItemTemplate>
                                <asp:Button ID="btnApprove" Text="Approve" runat="server" CausesValidation="false"  CommandArgument="<%# ((GridViewRow)Container).RowIndex %>" CommandName="Approve"/>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
