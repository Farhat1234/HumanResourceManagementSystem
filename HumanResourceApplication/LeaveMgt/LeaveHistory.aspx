<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="LeaveHistory.aspx.cs" Inherits="HumanResourceApplication.Leave_Mgt.LeaveHistory" %>
    ...
    <table class="style1">
        <tr>
            ...
            <td class="auto-style6">
                <br />
                <hr />
                <asp:GridView ID="grdLeaveHistory" runat="server" CellPadding="4" ForeColor="#333333" GridLines="Both" AutoGenerateColumns="False">
