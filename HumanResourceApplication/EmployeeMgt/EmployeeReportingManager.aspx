<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="EmployeeReportingManager.aspx.cs" Inherits="HumanResourceApplication.EmployeeMgt.EmployeeReportingManager" %>
...
<aside id="menu">
       ...
       <div class="row">
        <div class="col-md-12">
            <div class="text-center m-b-md">
                <h3><B>Organizational Hierarchy</B></h3>
                <small>Choose An Employee To View The Hierarchy </small>
            </div>
            <div class="hpanel">
  ...
  <div class="form-group">
            ...
            <span class="icon-case"><i class="fa fa-user"></i></span>
				   <asp:DropDownList ID="drpChooseManager" runat="server" class="dropdownlist">
                </asp:DropDownList>
			</div>
                            </div>
                   ...
                   <asp:Button ID="btnChangeRM" runat="server" Text="View"  class="btn btn-success"/>
                </div>
            </div>
           </div>
